package com.practice.udemy.exceptionHandlingPartThree;
...
public class App {
	...
	public static void main(String[] args) {
		...
		// if we write mother class before child class then java will not allow. 
		//it will show unreachable catch block in IDE, below catch block will not work after Exception catch block,
		//to work move above the the exception catch block
		/*
